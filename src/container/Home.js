            ...
            >
              ...
              <div className="card-content">
               ...
               {post.likes.includes(state._id) ? (
                 <i
                 style={{ color: "#ad1457", cursor:"pointer", marginTop:'11px' }}
                 className="material-icons"
                 onClick={() => {
                   unlikePost(post._id);
                  }}
                  ...
                  thumb_down
                    ...
                    <i
                    style={{ color: "#ad1457" ,cursor:"pointer", marginTop:'7px'}}
                    className="material-icons"
                    onClick={() => {
                      likePost(post._id);
                    }}
                ...
                <div style={{ margin: "4px 0px", color: "#ad1457", cursor:'default' }}>
              ...
              >
                ...
                <div style={{ maxHeight: "100px",overflowX:'hidden', overflow: "scroll" }}>
                  <List>
                    {post.comments.map((comment, index) => {
                      return (
                        <ListItem key={index} style={{padding:'0px',cursor:'default'}}>
                          <ListItemText
